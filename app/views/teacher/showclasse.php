    ...
    <main class="flex-1 p-10 overflow-y-auto">
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="/teacher/classes/<?= $class->getIdClasse() ?>/add-work" class="inline-flex items-center px-5 py-2.5 bg-indigo-600 text-sm font-bold rounded-xl text-white hover:bg-indigo-700 shadow-lg shadow-indigo-100 transition-all">
